...
`IF_2026-04-16_v2`, new imaging `IF_2026-09-01_v1`. Probe-design versions: `probe-design_v3`.
...
| `probe-design_v3` | probe-design | E–P coordinates v3 (mm10) | complete | private | 95 RNA + 95 DNA symmetric panel; Klf4/Car2 added | [probe-design](lab-notebook/probe-design.md) |

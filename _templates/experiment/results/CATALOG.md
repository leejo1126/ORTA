...
Visibility of this run's outputs is set in `MANIFEST.md` (`Visibility: public|private`) and rolled up in
`release-manifest.md`; flag any per-file exception in the row's Links/notes.
